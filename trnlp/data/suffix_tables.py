...
ice = (1,
       (1, 0, 'Çe', 'l[ae]r', (-1, 2, 4, 6, 8, 11, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 42, 44, 46, 48, 50),
        (2, 13), ''),
       (2, 1, 'İe1t', '[ıiuü]m', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 44, 46, 48, 50, 54), (0, 6), 't'),
       (3, 1, 'İe1t', 'm', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 44, 46, 48, 50, 54), (1,), 't'),
       (4, 1, 'İe1ç', '[ıiuü]m[ıiuü]z', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 44, 46, 50, 54), (0, 6, 13), 'ç'),
       (5, 1, 'İe1ç', 'm[ıiuü]z', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 44, 46, 50, 54), (1, 13), 'ç'),
       (6, 1, 'İe2t', '[ıiuü]n', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 42, 44, 46, 48, 50, 54), (0, 6), 't'),
       (7, 1, 'İe2t', 'n', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 42, 44, 46, 48, 50, 54), (1,), 't'),
       (8, 1, 'İe2ç', '[ıiuü]n[ıiuü]z', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 42, 46, 54), (0, 6, 13), 'ç'),
       (9, 1, 'İe2ç', 'n[ıiuü]z', (-1, 14, 17, 20, 21, 23, 26, 28, 36, 38, 40, 42, 46, 54), (1, 13), 'ç'),
       (10, 1, 'İe3t', 's[ıiuü]', (-1, 15, 16, 18, 22, 24, 25, 29, 35, 37, 39, 41, 44, 46, 47, 50, 54), (1, 3), 't'),
       (11, 1, 'İe3t', '[ıiuü]', (-1, 15, 16, 18, 22, 24, 25, 29, 35, 37, 39, 41, 44, 46, 47, 50, 54, 56), (0,), 't'),
       (12, 1, 'İe3ç', 'l[ae]r[ıi]', (-1, 15, 16, 18, 22, 24, 25, 29, 35, 37, 39, 41, 44, 46, 47, 50, 54), (2, 13), 'ç'),
       ...
       (41, 1, 'EfKe1t', 'y[ıiuü]m', (-1, 46), (1, 3, 6), 't'),
       (42, 1, 'EfKe1t', '[ıiuü]m', (-1,), (0, 6), 't'),
       (43, 1, 'EfKe1t', 'm', (0,), (1,), 't'),
       (44, 1, 'EfKe2t', 's[ıiuü]n', (-1,), (2, 3, 6), 't'),
       (45, 1, 'EfKe2t', 'n', (0,), (1,), 't'),
       (46, 1, 'EfGz', '[dt][ıiuü]r', (-1,), (2, 4), ''),
       (47, 1, 'EfKe1ç', 'y[ıiuü]z', (-1, 46), (1, 3, 13), 'ç'),
       (48, 1, 'EfKe1ç', '[ıiuü]z', (-1, 46), (0, 13), 'ç'),
       (49, 1, 'EfKe1ç', 'k', (0,), (1, 13), 'ç'),
       (50, 1, 'EfKe2ç', 's[ıiuü]n[ıiuü]z', (-1, 46), (2, 3, 6, 13), 'ç'),
       (51, 1, 'EfKe2ç', 'n[ıiuü]z', (0,), (1, 13), 'ç'),
       (52, 1, 'EfKe3ç', 'l[ae]r', (-1,), (2, 13), 'ç'),
       (53, 1, 'EfKe3ç', 'l[ae]rd[ıi]r', (-1,), (2, 13), 'ç'),
       (54, 1, 'EfKe3ç', '[dt][ıiuü]rl[ae]r', (-1,), (2, 4, 13), 'ç'),
...
fce = (2,
       ...
       (19, 1, 'Ke1t', 'y[ıiuü]m', (0,), (1, 3, 6), 't'),
       (20, 1, 'Ke1t', '[ıiuü]m', (54,), (0, 6), 't'),
       (21, 1, 'Ke1t', 'm', (48, 54), (1,), 't'),
       (22, 1, 'Ke2t', 's[ıiuü]n', (54,), (2, 3, 6), 't'),
       (23, 1, 'Ke2t', 'n', (0,), (1,), 't'),
       (24, 1, 'Ke1ç', '[ıiuü]z', (0,), (0, 13), 'ç'),
       (25, 1, 'Ke1ç', 'y[ıiuü]z', (0,), (1, 3, 13), 'ç'),
       (26, 1, 'Ke1ç', 'l[ıi]m', (0,), (2, 13), 'ç'),
       (27, 1, 'Ke1ç', 'k', (0,), (1, 13), 'ç'),
       (28, 1, 'Ke2ç', 's[ıiuü]n[ıiuü]z', (54, 60), (2, 3, 6, 13), 'ç'),
       (29, 1, 'Ke2ç', 'n[ıiuü]z', (0,), (2, 13), 'ç'),
       (30, 1, 'Ke3ç', 'l[ae]r', (44, 46, 48, 53), (2, 13), 'ç'),
       ...
       (49, 1, 'EfKe1t', '[ıiuü]m', (54,), (0, 6), 't'),
       (50, 1, 'EfKe1t', 'm', (0,), (1,), 't'),
       (51, 1, 'EfKe2t', 's[ıiuü]n', (54,), (0, 3, 6), 't'),
       (52, 1, 'EfKe2t', 'n', (0,), (1,), 't'),
       (53, 1, 'EfGz', '[dt][ıiuü]r', (-1, 59), (0, 4), ''),
       (54, 1, 'EfGz', '[dt][ıiuü]r', (0,), (0, 4), ''),
       (55, 1, 'EfKe1ç', '[ıiuü]z', (54,), (0, 13), 'ç'),
       (56, 1, 'EfKe1ç', 'k', (0,), (1, 13), 'ç'),
       (57, 1, 'EfKe2ç', 's[ıiuü]n[ıiuü]z', (54,), (0, 3, 6, 13), 'ç'),
       (58, 1, 'EfKe2ç', 'n[ıiuü]z', (0,), (1, 13), 'ç'),
       (59, 1, 'EfKe3ç', 'l[ae]r', (54,), (2, 13), 'ç'),
...
soru = (10,
        ...
        (3, 1, 'EfKe1t', '[ıiuü]m', (0,), (0, 6), 't'),
        (4, 1, 'EfKe1t', 'm', (-1,), (0,), 't'),
        (5, 1, 'EfKe2t', 's[ıiuü]n', (-1,), (0, 3, 6), 't'),
        (6, 1, 'EfKe2t', 'n', (-1,), (0,), 't'),
        (7, 1, 'EfKe1ç', '[ıiuü]z', (0,), (0,), 'ç'),
        (8, 1, 'EfKe1ç', 'y[ıiuü]z', (-1,), (0,), 'ç'),
        (9, 1, 'EfKe1ç', 'k', (0,), (1,), 'ç'),
        (10, 1, 'EfKe2ç', 's[ıiuü]n[ıiuü]z', (-1,), (0, 3, 6), 'ç'),
        (11, 1, 'EfKe2ç', 'n[ıiuü]z', (0,), (1,), 'ç'),
        (12, 1, 'EfKe3ç', 'l[ae]r', (-1,), (2,), 'ç'))
